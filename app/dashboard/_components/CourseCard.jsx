...
function CourseCard({course,refreshData,displayUser=false}) {
  ...
  return (
    ...
    <div className='shadow-sm rounded-lg border p-2 cursor-pointer mt-4'>
        ...
        <Image src={'/placeholder.png'} width={300} height={300} alt="img" className='w-full h-[200px] object-cover rounded-lg'/>
        </Link>
        <div className='p-2'>
            ...
            <div className='flex items-center justify-between'>
                <h2 className='flex gap-2 items-center p-1 bg-purple-50 text-primary text-sm rounded-sm'>
                   <HiOutlineBookOpen/> {course?.courseOutput?.numberOfChapters} Chapters
                </h2>
           ...
           {displayUser && <div className='flex gap-2 items-center mt-2'> 
                <Image src={course?.userProfileImage} width={35} height={35} alt='image'
